...
export const experiences: Experience[] = [
  {
    ...
    description: "Leading frontend development for enterprise applications using Next.js and React.",
    achievements: [
  ...
  },
  {
    ...
    description: "Leading technical workshops and community events for developers.",
    achievements: [
...
export const certifications: Certification[] = [
  ...
  },
  {
    ...
    issuer: "Google",
    date: "2021",
    description: "Professional certification in user experience design and research.",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: "A real-time collaborative task management application similar to Trello, built with React and Firebase. Features include drag-and-drop kanban boards, real-time collaboration, team management, and custom workflows. Supports 1000+ concurrent users with instant updates across all devices.",
  ...
  },
  {
    ...
    longDescription: "A drag-and-drop portfolio builder that allows developers to create beautiful portfolio websites without coding. Features include customizable templates, GitHub integration, project showcase, blog functionality, and SEO optimization. Over 5,000 developers have created their portfolios using this platform.",
  ...
  },
  {
    ...
    longDescription: "An intelligent code assistant extension for Visual Studio Code that provides context-aware code suggestions, automatic documentation, and code refactoring recommendations. Powered by OpenAI's GPT-4, it helps developers write better code faster. Currently used by 10,000+ developers worldwide.",

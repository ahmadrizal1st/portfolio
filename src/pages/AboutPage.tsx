      ...
      <div className="container mx-auto px-4">
          ...
          <div className="border-2 border-black p-8 md:p-12 bg-white">
            ...
            <div className="prose max-w-none">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                I'm passionate about creating elegant solutions to complex problems. My journey in software
                development started over {experiences.length} years ago, and I've had the privilege of working
                on diverse projects across various industries.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                When I'm not coding, you can find me contributing to open-source projects, mentoring aspiring
                developers, or exploring new technologies and frameworks.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: <Heart size={32} />,
                title: 'User Focus',
                description: 'Building products with the end-user in mind, ensuring great experiences and accessibility.'
              },
              {
                icon: <Zap size={32} />,
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-5xl font-black mb-2">{experiences.length}</div>
              <div className="text-gray-700">Years Experience</div>
            </div>
            <div>
              <div className="text-5xl font-black mb-2">{experiences.reduce((sum, exp) => sum + exp.achievements.length, 0)}</div>
